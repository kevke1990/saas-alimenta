...
export const NORM_SETS: Record<NormYear, NormSet> = {
  2024:{year:2024,version:"2024.1",effectiveFrom:"2024-01-01",source:"Rechtspraak / Expertgroep Alimentatienormen",sourceVersion:"Rapport Alimentatienormen januari 2024 + bijlage juli 2024",needIncomePoints:NEED_POINTS_2024,needTable:NEED_TABLE_2024,capacity:CAPACITY_2024,careDiscount:CARE_DISCOUNT_RULES,wsfPeriods:WSF_PERIODS_2024},
  2025:{year:2025,version:"2025.1",effectiveFrom:"2025-01-01",source:"Rechtspraak / Expertgroep Alimentatienormen",sourceVersion:"Rapport Alimentatienormen januari 2025 + bijlage juli 2025",needIncomePoints:NEED_POINTS_2025,needTable:NEED_TABLE_2025,capacity:CAPACITY_2025,careDiscount:CARE_DISCOUNT_RULES,wsfPeriods:WSF_PERIODS_2025},
  2026:{year:2026,version:"2026.1",effectiveFrom:"2026-01-01",source:"Rechtspraak / Expertgroep Alimentatienormen",sourceVersion:"Rapport Alimentatienormen januari 2026 + bijlage juli 2026",needIncomePoints:NEED_POINTS_2026,needTable:NEED_TABLE_2026,capacity:CAPACITY_2026,careDiscount:CARE_DISCOUNT_RULES,wsfPeriods:WSF_PERIODS_2026},
};
export function getNormYearForDate(date:string):NormYear {
  ...
  if (!(year in NORM_SETS)) throw new Error(`Geen ondersteunde NormSet voor reken-/ingangsjaar ${year}.`);
  return year as NormYear;
}

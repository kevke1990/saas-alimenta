...
## Rules
- Keep `lib/calculator.ts`, `lib/income-engine.ts`, `lib/partner-alimony-engine.ts`, `lib/support-engine.ts`, `lib/norms.ts`, and calculation snapshot/provenance logic authoritative.

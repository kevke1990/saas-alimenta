...
export default async function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="app-shell app-shell-premium">
      <aside className="sidebar sidebar-premium" aria-label="Merelo werkplek">
        <div className="brand-lockup brand-lockup-premium"><MereloLogo href="/dashboard" compact /></div>

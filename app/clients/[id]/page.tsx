...
export default async function ClientPage({params}:{params:Promise<{id:string}>}){
 ...
 return <AppShell>
  ...
  <section className="panel topgap"><div className="panel-head"><div><div className="section-kicker">Gezinsleden</div><h2 className="panel-title">Contact & gezin</h2><div className="panel-sub">Deze personen worden automatisch voorgesteld bij een nieuw dossier.</div></div></div><div className="client-family-grid"><div className="client-family-card"><b>Persoon A</b><div className="topgap">{c.personAName||"Nog niet ingevuld"}</div><div className="subtle">{c.personAEmail||"Geen e-mail"} · {c.personAPhone||"Geen telefoon"}</div></div><div className="client-family-card"><b>Persoon B</b><div className="topgap">{c.personBName||"Nog niet ingevuld"}</div><div className="subtle">{c.personBEmail||"Geen e-mail"} · {c.personBPhone||"Geen telefoon"}</div></div></div></section>

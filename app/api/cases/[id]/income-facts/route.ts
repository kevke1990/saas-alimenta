  ...
  try {
    ...
    await db.auditLog.create({
      data: {
        ...
        metadata: { caseId: id, documentId: fact.documentId, incomeFactId: fact.id, key: fact.key, label: fact.label, valueNumber: fact.valueNumber, confidence: fact.confidence },
      },
    });
